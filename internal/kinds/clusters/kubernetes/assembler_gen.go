// Code generated by "gen-kindstubs -parentpath=github.com/caos/infrop/internal/kinds/clusters -versions=v1 -kind=infrop.caos.ch/KubernetesCluster from file gen.go"; DO NOT EDIT.
...
import (
	...
	v1builder "github.com/caos/infrop/internal/kinds/clusters/kubernetes/model/v1"
)
...
func (a *assembler) String() string { return "infrop.caos.ch/KubernetesCluster" }
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater operator.NodeAgentUpdater, secrets *operator.Secrets, dependant interface{}) (string, string, interface{}, map[string]operator.Assembler, error) {
	...
	if kind.Kind != "infrop.caos.ch/KubernetesCluster" {
		return "", "", nil, nil, fmt.Errorf("Kind %s must be \"infrop.caos.ch/KubernetesCluster\"", kind.Kind)
	}
