// Code generated by "gen-kindstubs -parentpath=github.com/caos/infrop/internal/kinds/loadbalancers/dynamic/kinds -versions=v1 -kind=infrop.caos.ch/DynamicKubeAPILoadBalancer from file gen.go"; DO NOT EDIT.
...
import (
	...
	"github.com/caos/infrop/internal/kinds/loadbalancers/dynamic/kinds/kubeapi/adapter"
	"github.com/caos/infrop/internal/kinds/loadbalancers/dynamic/kinds/kubeapi/model"
	v1builder "github.com/caos/infrop/internal/kinds/loadbalancers/dynamic/kinds/kubeapi/model/v1"
)
...
func (a *assembler) String() string { return "infrop.caos.ch/DynamicKubeAPILoadBalancer" }
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater operator.NodeAgentUpdater, secrets *operator.Secrets, dependant interface{}) (string, string, interface{}, map[string]operator.Assembler, error) {
	...
	if kind.Kind != "infrop.caos.ch/DynamicKubeAPILoadBalancer" {
		return "", "", nil, nil, fmt.Errorf("Kind %s must be \"infrop.caos.ch/DynamicKubeAPILoadBalancer\"", kind.Kind)
	}
