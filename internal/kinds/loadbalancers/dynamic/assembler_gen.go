...
"github.com/caos/orbiter/internal/core/operator/common"
	...
	v0builder "github.com/caos/orbiter/internal/kinds/loadbalancers/dynamic/model/v0"
)
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater orbiter.NodeAgentUpdater, secrets *orbiter.Secrets, dependant interface{}) (orbiter.Kind, interface{}, []orbiter.Assembler, string, error) {
	...
	if kind.Kind != "orbiter.caos.ch/DynamicLoadBalancer" {
		return kind, nil, nil, model.CurrentVersion, fmt.Errorf("Kind %s must be \"orbiter.caos.ch/DynamicLoadBalancer\"", kind.Kind)
	}
