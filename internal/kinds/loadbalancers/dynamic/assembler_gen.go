...
import (
	...
	"github.com/caos/infrop/internal/kinds/loadbalancers/dynamic/adapter"
	"github.com/caos/infrop/internal/kinds/loadbalancers/dynamic/model"
	v1builder "github.com/caos/infrop/internal/kinds/loadbalancers/dynamic/model/v1"
)
...
func (a *assembler) String() string { return "infrop.caos.ch/DynamicLoadBalancer" }
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater operator.NodeAgentUpdater, secrets *operator.Secrets, dependant interface{}) (string, string, interface{}, map[string]operator.Assembler, error) {
	...
	if kind.Kind != "infrop.caos.ch/DynamicLoadBalancer" {
		return "", "", nil, nil, fmt.Errorf("Kind %s must be \"infrop.caos.ch/DynamicLoadBalancer\"", kind.Kind)
	}
