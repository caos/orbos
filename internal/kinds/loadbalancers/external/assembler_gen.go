// Code generated by "gen-kindstubs -parentpath=github.com/caos/infrop/internal/kinds/loadbalancers -versions=v1 -kind=infrop.caos.ch/ExternalLoadBalancer from file gen.go"; DO NOT EDIT.
...
import (
	...
	"github.com/caos/infrop/internal/kinds/loadbalancers/external/adapter"
	"github.com/caos/infrop/internal/kinds/loadbalancers/external/model"
	v1builder "github.com/caos/infrop/internal/kinds/loadbalancers/external/model/v1"
)
...
func (a *assembler) String() string { return "infrop.caos.ch/ExternalLoadBalancer" }
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater operator.NodeAgentUpdater, secrets *operator.Secrets, dependant interface{}) (string, string, interface{}, map[string]operator.Assembler, error) {
	...
	if kind.Kind != "infrop.caos.ch/ExternalLoadBalancer" {
		return "", "", nil, nil, fmt.Errorf("Kind %s must be \"infrop.caos.ch/ExternalLoadBalancer\"", kind.Kind)
	}
