// Code generated by "gen-kindstubs -parentpath=github.com/caos/orbiter/internal/kinds/loadbalancers -versions=v1 -kind=orbiter.caos.ch/ExternalLoadBalancer from file gen.go"; DO NOT EDIT.
...
import (
	...
	v1builder "github.com/caos/orbiter/internal/kinds/loadbalancers/external/model/v1"
)
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater operator.NodeAgentUpdater, secrets *operator.Secrets, dependant interface{}) (string, string, interface{}, map[string]operator.Assembler, error) {
	...
	if kind.Kind != "orbiter.caos.ch/ExternalLoadBalancer" {
		return "", "", nil, nil, fmt.Errorf("Kind %s must be \"orbiter.caos.ch/ExternalLoadBalancer\"", kind.Kind)
	}
