// Code generated by "gen-kindstubs -parentpath=github.com/caos/infrop/internal/kinds -versions=v1 -kind=infrop.caos.ch/Infrop from file gen.go"; DO NOT EDIT.
...
import (
	...
	v1builder "github.com/caos/infrop/internal/kinds/infrop/model/v1"
)
...
func (a *assembler) String() string { return "infrop.caos.ch/Infrop" }
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater operator.NodeAgentUpdater, secrets *operator.Secrets, dependant interface{}) (string, string, interface{}, map[string]operator.Assembler, error) {
	...
	if kind.Kind != "infrop.caos.ch/Infrop" {
		return "", "", nil, nil, fmt.Errorf("Kind %s must be \"infrop.caos.ch/Infrop\"", kind.Kind)
	}
