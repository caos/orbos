...
import (
	...
	v0builder "github.com/caos/orbiter/internal/kinds/nodeagent/model/v0"
)
...
func (a *assembler) String() string { return "nodeagent.caos.ch/NodeAgent" }
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater orbiter.NodeAgentUpdater, secrets *orbiter.Secrets, dependant interface{}) (orbiter.Kind, interface{}, []orbiter.Assembler, string, error) {
	...
	if kind.Kind != "nodeagent.caos.ch/NodeAgent" {
		return kind, nil, nil, model.CurrentVersion, fmt.Errorf("Kind %s must be \"nodeagent.caos.ch/NodeAgent\"", kind.Kind)
	}
