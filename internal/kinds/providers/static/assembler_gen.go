// Code generated by "gen-kindstubs -parentpath=github.com/caos/infrop/internal/kinds/providers -versions=v1 -kind=infrop.caos.ch/StaticProvider from file gen.go"; DO NOT EDIT.
...
import (
	...
	"github.com/caos/infrop/internal/kinds/providers/static/adapter"
	"github.com/caos/infrop/internal/kinds/providers/static/model"
	v1builder "github.com/caos/infrop/internal/kinds/providers/static/model/v1"
)
...
func (a *assembler) String() string { return "infrop.caos.ch/StaticProvider" }
...
func (a *assembler) Build(serialized map[string]interface{}, nodeagentupdater operator.NodeAgentUpdater, secrets *operator.Secrets, dependant interface{}) (string, string, interface{}, map[string]operator.Assembler, error) {
	...
	if kind.Kind != "infrop.caos.ch/StaticProvider" {
		return "", "", nil, nil, fmt.Errorf("Kind %s must be \"infrop.caos.ch/StaticProvider\"", kind.Kind)
	}
