...
type Toleration struct {
	...
	//Operator represents a key's relationship to the value. Valid operators are Exists and Equals. Defaults to Equals. Exists is equivalent to wildcard for value, so that a pod can tolerate all taints of a particular category.
