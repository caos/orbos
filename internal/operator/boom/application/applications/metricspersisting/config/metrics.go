...
import (
	...
	ambassadormetrics "github.com/caos/orbos/v5/internal/operator/boom/application/applications/apigateway/metrics"
	"github.com/caos/orbos/v5/internal/operator/boom/application/applications/apiserver"
	...
	kubestatemetrics "github.com/caos/orbos/v5/internal/operator/boom/application/applications/kubemetricsexporter/metrics"
	lometrics "github.com/caos/orbos/v5/internal/operator/boom/application/applications/logcollection/metrics"
	lokimetrics "github.com/caos/orbos/v5/internal/operator/boom/application/applications/logspersisting/metrics"
	pometrics "github.com/caos/orbos/v5/internal/operator/boom/application/applications/metriccollection/metrics"
	"github.com/caos/orbos/v5/internal/operator/boom/application/applications/metricspersisting/metrics"
	...
	pnemetrics "github.com/caos/orbos/v5/internal/operator/boom/application/applications/nodemetricsexporter/metrics"
	"github.com/caos/orbos/v5/internal/operator/boom/application/applications/orbiter"
	argocdmetrics "github.com/caos/orbos/v5/internal/operator/boom/application/applications/reconciling/metrics"
	psemetrics "github.com/caos/orbos/v5/internal/operator/boom/application/applications/systemdmetricsexporter/metrics"
