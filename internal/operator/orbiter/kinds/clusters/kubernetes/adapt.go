...
func AdaptFunc(
	...
	destroy bool,
	takeoff bool,
	ensureProviders func(psf orbiter.PushSecretsFunc, nodeAgentsCurrent map[string]*common.NodeAgentCurrent, nodeAgentsDesired map[string]*common.NodeAgentSpec) (map[string]interface{}, error)) orbiter.AdaptFunc {
