...
var kubernetesVersions = []string{
	...
	"v1.16.0", "v1.16.1", "v1.16.2", "v1.16.3", "v1.16.4", "v1.16.5", "v1.16.6", "v1.16.7", "v1.16.8", "v1.16.9", "v1.16.10", "v1.16.11", "v1.16.12", "v1.16.13", "v1.16.14", "v1.16.15",
	...
	"v1.18.0", "v1.18.1", "v1.18.2", "v1.18.3", "v1.18.4", "v1.18.5", "v1.18.6", "v1.18.7", "v1.18.8", "v1.18.9", "v1.18.10", "v1.18.11", "v1.18.12", "v1.18.13", "v1.18.14", "v1.18.15", "v1.18.16", "v1.18.17", "v1.18.18", "v1.18.19", "v1.18.20",
	"v1.19.0", "v1.19.1", "v1.19.2", "v1.19.3", "v1.19.4", "v1.19.5", "v1.19.6", "v1.19.7", "v1.19.8", "v1.19.9", "v1.19.10", "v1.19.11", "v1.19.12", "v1.19.13", "v1.19.14", "v1.19.15", "v1.19.16",
	"v1.20.0", "v1.20.1", "v1.20.2", "v1.20.3", "v1.20.4", "v1.20.5", "v1.20.6", "v1.20.7", "v1.20.8", "v1.20.9", "v1.20.10", "v1.20.11", "v1.20.12", "v1.20.13", "v1.20.14", "v1.20.15",
	"v1.21.0", "v1.21.1", "v1.21.2", "v1.21.3", "v1.21.4", "v1.21.5", "v1.21.6", "v1.21.7", "v1.21.8", "v1.21.9",
	"v1.22.0", "v1.22.1", "v1.22.2", "v1.22.3", "v1.22.4", "v1.22.5", "v1.22.6",
...
func (k KubernetesVersion) NextHighestMinor() KubernetesVersion {
	...
	case V1x15x0, V1x15x1, V1x15x2, V1x15x3, V1x15x4, V1x15x5, V1x15x6, V1x15x7, V1x15x8, V1x15x9, V1x15x10, V1x15x11, V1x15x12:
		return V1x16x15
	case V1x16x0, V1x16x1, V1x16x2, V1x16x3, V1x16x4, V1x16x5, V1x16x6, V1x16x7, V1x16x8, V1x16x9, V1x16x10, V1x16x11, V1x16x12, V1x16x13, V1x16x14, V1x16x15:
		return V1x17x17
	case V1x17x0, V1x17x1, V1x17x2, V1x17x3, V1x17x4, V1x17x5, V1x17x6, V1x17x7, V1x17x8, V1x17x9, V1x17x10, V1x17x11, V1x17x12, V1x17x13, V1x17x14, V1x17x15, V1x17x16, V1x17x17:
		return V1x18x20
	case V1x18x0, V1x18x1, V1x18x2, V1x18x3, V1x18x4, V1x18x5, V1x18x6, V1x18x7, V1x18x8, V1x18x9, V1x18x10, V1x18x11, V1x18x12, V1x18x13, V1x18x14, V1x18x15, V1x18x16, V1x18x17, V1x18x18, V1x18x19, V1x18x20:
		return V1x19x16
	case V1x19x0, V1x19x1, V1x19x2, V1x19x3, V1x19x4, V1x19x5, V1x19x6, V1x19x7, V1x19x8, V1x19x9, V1x19x10, V1x19x11, V1x19x12, V1x19x13, V1x19x14, V1x19x15, V1x19x16:
		return V1x20x15
	case V1x20x0, V1x20x1, V1x20x2, V1x20x3, V1x20x4, V1x20x5, V1x20x6, V1x20x7, V1x20x8, V1x20x9, V1x20x10, V1x20x11, V1x20x12, V1x20x13, V1x20x14, V1x20x15:
		return V1x21x9
	case V1x21x0, V1x21x1, V1x21x2, V1x21x3, V1x21x4, V1x21x5, V1x21x6, V1x21x7, V1x21x8, V1x21x9:
		return V1x22x6
	case V1x22x0, V1x22x1, V1x22x2, V1x22x3, V1x22x4, V1x22x5, V1x22x6:
		return V1x23x2
	default:
		return Unknown
	}
