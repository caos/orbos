...
func AdaptFunc(
	...
	checkDBRunning := func(k8sClient *kubernetes2.Client) error {
	...
	checkDBNotReady := func(k8sClient *kubernetes2.Client) error {
	...
	ensureInit := func(k8sClient *kubernetes2.Client) error {
	...
	checkDBReady := func(k8sClient *kubernetes2.Client) error {
