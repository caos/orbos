...
func NewGitClient(ctx context.Context, monitor mntr.Monitor, conf *Config, checks bool) (*git.Client, string, func(), error) {
	deployKeyPriv := ""
	...
	return gitClient, deployKeyPriv, deployKeyDelete, nil
}
